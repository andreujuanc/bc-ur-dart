import 'package:bc_ur/src/urDecoder.dart';
import 'package:bc_ur/src/urEncoder.dart';
...
void main() {
  group('UR', () {
    ...
    // group('UR Encoder', () {
    //   test('encoder test', () {
    //     var message = makeMessageUR(256);
    //     var encoder = new UREncoder(message, 30)
    //     var parts = [...new Array(20)].map(() => encoder.nextPart())
    //     var expectedParts = [
