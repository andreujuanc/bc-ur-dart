...
group('Xoshiro', () {
  test('1', () {
    ...
    var numbers = List<int>.generate(100, (index) => 0).map((i) => rng.next() % Decimal.fromInt(10));
    var expectedNumbers = [42, 81, 85, 8, 82, 84, 76, 73, 70, 88, 2, 74, 40, 48, 77, 54, 88, 7, 5, 88, 37, 25, 82, 13, 69, 59, 30, 39, 11, 82, 19, 99, 45, 87, 30, 15, 32, 22, 89, 44, 92, 77, 29, 78, 4, 92, 44, 68, 92, 69, 1, 42, 89, 50, 37, 84, 63, 34, 32, 3, 17, 62, 40, 98, 82, 89, 24, 43, 85, 39, 15, 3, 99, 29, 20, 42, 27, 10, 85, 66, 50, 35, 69, 70, 70, 74, 30, 13, 72, 54, 11, 5, 70, 55, 91, 52, 10, 43, 43, 52];
  ...
  test('2', () {
    ...
    var numbers = List<int>.generate(100, (index) => 0).map((o) => rng.next() % Decimal.fromInt(10));
